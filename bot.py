...
cards = [
    ...
    {"name": "импотян", "rarity": 0.10, "coins": 70, "image_id": "AgACAgIAAxkBAAPsaItLCXiAePKqn_9a2L0SyEiqeWgAAnryMRvZAmFI_YRGZoEf9UABAAMCAAN5AAM2BA"}, # Пример file_id (замени на свой!)
